...
- **B=16 non-MTP (2026-09-08 late, the current best)**: `[megab] replay 16 seqs: 16.23-16.48 ms`
  = **978-985 tok/s** (300-token window, text = direct 《出师表》 recitation ✓); 1000-token window
  17.97-18.00 ms = **889-891 tok/s**. Progression this session: 546 → ~980 tok/s.
