...
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(const fp8_e4_t* __restrict__ A, const float* __restrict__ ASC, float* __restrict__ P, const fp8_e4_t* __restrict__ W, const fp8_e8_t* __restrict__ WSC, int m) {
  ...
  for (int i_1 = 0; i_1 < 2; ++i_1) {
    tl::cp_async_gs<16>((&(((fp8_e4_t*)W_sh)[(((i_1 * 2048) + ((((int)threadIdx.x) >> 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 16))])), (&(W[(((((((int)blockIdx.x) * 163840) + (i_1 * 81920)) + ((((int)threadIdx.x) >> 1) * 1280)) + (((int)blockIdx.y) * 160)) + ((((int)threadIdx.x) & 1) * 16))])));
  }
  tl::cp_async_commit();
  #pragma unroll
  for (int i_2 = 0; i_2 < 2; ++i_2) {
    tl::cp_async_gs<16>((&(((fp8_e4_t*)W_sh)[((((i_2 * 2048) + ((((int)threadIdx.x) >> 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 16)) + 4096)])), (&(W[((((((((int)blockIdx.x) * 163840) + (i_2 * 81920)) + ((((int)threadIdx.x) >> 1) * 1280)) + (((int)blockIdx.y) * 160)) + ((((int)threadIdx.x) & 1) * 16)) + 32)])));
  }
  tl::cp_async_commit();
  #pragma unroll
  for (int i_3 = 0; i_3 < 2; ++i_3) {
    tl::cp_async_gs<16>((&(((fp8_e4_t*)W_sh)[((((i_3 * 2048) + ((((int)threadIdx.x) >> 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 16)) + 8192)])), (&(W[((((((((int)blockIdx.x) * 163840) + (i_3 * 81920)) + ((((int)threadIdx.x) >> 1) * 1280)) + (((int)blockIdx.y) * 160)) + ((((int)threadIdx.x) & 1) * 16)) + 64)])));
  }
  tl::cp_async_commit();
  for (int ko = 0; ko < 2; ++ko) {
    __syncthreads();
    if ((((int)threadIdx.x) >> 3) < m) {
      *(fp8_e4_4_t*)(((fp8_e4_t*)A_sh) + ((((((int)threadIdx.x) >> 3) * 32) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 16)) + ((((int)threadIdx.x) & 3) * 4))) = *(fp8_e4_4_t*)(A + (((((((int)threadIdx.x) >> 3) * 1280) + (((int)blockIdx.y) * 160)) + (ko * 32)) + ((((int)threadIdx.x) & 7) * 4)));
    } else {
    ...
    __syncthreads();
    {
      ...
      for (int i_5 = 0; i_5 < 2; ++i_5) {
        tl::ptx_ldmatrix_x4((&(((fp8_e4_t*)W_sh)[((((((ko * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + (i_5 * 512)) + (((((int)threadIdx.x) & 31) >> 4) * 256)) + ((((int)threadIdx.x) & 7) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 16))])), (&(B_local[(i_5 * 16)])));
      }
      for (int j = 0; j < 2; ++j) {
    ...
    for (int i_6 = 0; i_6 < 2; ++i_6) {
      tl::cp_async_gs<16>((&(((fp8_e4_t*)W_sh)[((((ko * 4096) + (i_6 * 2048)) + ((((int)threadIdx.x) >> 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 16))])), (&(W[(((((((((int)blockIdx.x) * 163840) + (i_6 * 81920)) + ((((int)threadIdx.x) >> 1) * 1280)) + (((int)blockIdx.y) * 160)) + (ko * 32)) + ((((int)threadIdx.x) & 1) * 16)) + 96)])));
    }
    tl::cp_async_commit();
    #pragma unroll
    for (int i_7 = 0; i_7 < 8; ++i_7) {
      float ASC_local_cast[2];
      *(float2*)(ASC_local_cast + 0) = make_float2(ASC[(((((i_7 & 1) * 320) + (((((int)threadIdx.x) & 31) >> 2) * 40)) + (((int)blockIdx.y) * 5)) + ko)], ASC[(((((i_7 & 1) * 320) + (((((int)threadIdx.x) & 31) >> 2) * 40)) + (((int)blockIdx.y) * 5)) + ko)]);
      float2 __1;
        float2 __2;
          float2 v_ = *(float2*)(C_p + (i_7 * 2));
          float2 v__1 = *(float2*)(ASC_local_cast + 0);
          *(float2*)(&(__2.x)) = tl::mul2(*(float2*)(&(v_.x)), *(float2*)(&(v__1.x)));
        float2 v__2 = make_float2(((float)WSC[((((((int)blockIdx.x) * 160) + ((((int)threadIdx.x) >> 5) * 40)) + (((int)blockIdx.y) * 5)) + ko)]), ((float)WSC[((((((int)blockIdx.x) * 160) + ((((int)threadIdx.x) >> 5) * 40)) + (((int)blockIdx.y) * 5)) + ko)]));
  ...
  __syncthreads();
  if ((((int)threadIdx.x) >> 3) < m) {
    *(fp8_e4_4_t*)(((fp8_e4_t*)A_sh) + ((((((int)threadIdx.x) >> 3) * 32) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 16)) + ((((int)threadIdx.x) & 3) * 4))) = *(fp8_e4_4_t*)(A + (((((((int)threadIdx.x) >> 3) * 1280) + (((int)blockIdx.y) * 160)) + ((((int)threadIdx.x) & 7) * 4)) + 64));
  } else {
  ...
  for (int i_10 = 0; i_10 < 8; ++i_10) {
    ...
    *(float2*)(ASC_local_cast_1 + 0) = make_float2(ASC[(((((i_10 & 1) * 320) + (((((int)threadIdx.x) & 31) >> 2) * 40)) + (((int)blockIdx.y) * 5)) + 2)], ASC[(((((i_10 & 1) * 320) + (((((int)threadIdx.x) & 31) >> 2) * 40)) + (((int)blockIdx.y) * 5)) + 2)]);
    float2 __3;
      float2 __4;
        float2 v__4 = *(float2*)(C_p + (i_10 * 2));
        float2 v__5 = *(float2*)(ASC_local_cast_1 + 0);
        *(float2*)(&(__4.x)) = tl::mul2(*(float2*)(&(v__4.x)), *(float2*)(&(v__5.x)));
      float2 v__6 = make_float2(((float)WSC[((((((int)blockIdx.x) * 160) + ((((int)threadIdx.x) >> 5) * 40)) + (((int)blockIdx.y) * 5)) + 2)]), ((float)WSC[((((((int)blockIdx.x) * 160) + ((((int)threadIdx.x) >> 5) * 40)) + (((int)blockIdx.y) * 5)) + 2)]));
  ...
  __syncthreads();
  if ((((int)threadIdx.x) >> 3) < m) {
    *(fp8_e4_4_t*)(((fp8_e4_t*)A_sh) + ((((((int)threadIdx.x) >> 3) * 32) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 16)) + ((((int)threadIdx.x) & 3) * 4))) = *(fp8_e4_4_t*)(A + (((((((int)threadIdx.x) >> 3) * 1280) + (((int)blockIdx.y) * 160)) + ((((int)threadIdx.x) & 7) * 4)) + 96));
  } else {
  ...
  for (int i_13 = 0; i_13 < 8; ++i_13) {
    ...
    *(float2*)(ASC_local_cast_2 + 0) = make_float2(ASC[(((((i_13 & 1) * 320) + (((((int)threadIdx.x) & 31) >> 2) * 40)) + (((int)blockIdx.y) * 5)) + 3)], ASC[(((((i_13 & 1) * 320) + (((((int)threadIdx.x) & 31) >> 2) * 40)) + (((int)blockIdx.y) * 5)) + 3)]);
    float2 __5;
      float2 __6;
        float2 v__8 = *(float2*)(C_p + (i_13 * 2));
        float2 v__9 = *(float2*)(ASC_local_cast_2 + 0);
        *(float2*)(&(__6.x)) = tl::mul2(*(float2*)(&(v__8.x)), *(float2*)(&(v__9.x)));
      float2 v__10 = make_float2(((float)WSC[((((((int)blockIdx.x) * 160) + ((((int)threadIdx.x) >> 5) * 40)) + (((int)blockIdx.y) * 5)) + 3)]), ((float)WSC[((((((int)blockIdx.x) * 160) + ((((int)threadIdx.x) >> 5) * 40)) + (((int)blockIdx.y) * 5)) + 3)]));
  ...
  __syncthreads();
  if ((((int)threadIdx.x) >> 3) < m) {
    *(fp8_e4_4_t*)(((fp8_e4_t*)A_sh) + ((((((int)threadIdx.x) >> 3) * 32) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 16)) + ((((int)threadIdx.x) & 3) * 4))) = *(fp8_e4_4_t*)(A + (((((((int)threadIdx.x) >> 3) * 1280) + (((int)blockIdx.y) * 160)) + ((((int)threadIdx.x) & 7) * 4)) + 128));
  } else {
  ...
  for (int i_16 = 0; i_16 < 8; ++i_16) {
    ...
    *(float2*)(ASC_local_cast_3 + 0) = make_float2(ASC[(((((i_16 & 1) * 320) + (((((int)threadIdx.x) & 31) >> 2) * 40)) + (((int)blockIdx.y) * 5)) + 4)], ASC[(((((i_16 & 1) * 320) + (((((int)threadIdx.x) & 31) >> 2) * 40)) + (((int)blockIdx.y) * 5)) + 4)]);
    float2 __7;
      float2 __8;
        float2 v__12 = *(float2*)(C_p + (i_16 * 2));
        float2 v__13 = *(float2*)(ASC_local_cast_3 + 0);
        *(float2*)(&(__8.x)) = tl::mul2(*(float2*)(&(v__12.x)), *(float2*)(&(v__13.x)));
      float2 v__14 = make_float2(((float)WSC[((((((int)blockIdx.x) * 160) + ((((int)threadIdx.x) >> 5) * 40)) + (((int)blockIdx.y) * 5)) + 4)]), ((float)WSC[((((((int)blockIdx.x) * 160) + ((((int)threadIdx.x) >> 5) * 40)) + (((int)blockIdx.y) * 5)) + 4)]));
  ...
  for (int i_17 = 0; i_17 < 8; ++i_17) {
    *(float2*)(P + (((((((((int)blockIdx.y) * 65536) + ((i_17 & 1) * 32768)) + (((((int)threadIdx.x) & 31) >> 2) * 4096)) + (((int)blockIdx.x) * 128)) + ((((int)threadIdx.x) >> 5) * 32)) + ((i_17 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(C_l + (i_17 * 2));
  }
}
