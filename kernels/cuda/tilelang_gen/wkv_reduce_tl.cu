...
extern "C" __global__ void main_kernel(float* __restrict__ C, const float* __restrict__ P);
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(float* __restrict__ C, const float* __restrict__ P) {
  #pragma unroll
  for (int i = 0; i < 2; ++i) {
    ulonglong4 __1;
      ulonglong4 __2;
