// ============================================================================
// GENERATED — do not edit. Regenerate via kernels/tilelang/gen_proj_shapes_aot.py
// on a B300 (tilelang 0.1.14, sm_103a); see tilelang_gen/PROVENANCE.md.
// File: wo_a_g8_partial_tl.cu
...
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(const fp8_e4_t* __restrict__ A, const float* __restrict__ ASC, float* __restrict__ P, const fp8_e4_t* __restrict__ W, const fp8_e8_t* __restrict__ WSC, int m) {
  ...
  for (int i_1 = 0; i_1 < 2; ++i_1) {
    tl::cp_async_gs<16>((&(((fp8_e4_t*)W_sh)[(((i_1 * 2048) + ((((int)threadIdx.x) >> 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 16))])), (&(W[((((((((int)blockIdx.y) * 4194304) + (((int)blockIdx.x) * 524288)) + (i_1 * 262144)) + ((((int)threadIdx.x) >> 1) * 4096)) + (((int)blockIdx.z) * 512)) + ((((int)threadIdx.x) & 1) * 16))])));
  }
  tl::cp_async_commit();
  #pragma unroll
  for (int i_2 = 0; i_2 < 2; ++i_2) {
    tl::cp_async_gs<16>((&(((fp8_e4_t*)W_sh)[((((i_2 * 2048) + ((((int)threadIdx.x) >> 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 16)) + 4096)])), (&(W[(((((((((int)blockIdx.y) * 4194304) + (((int)blockIdx.x) * 524288)) + (i_2 * 262144)) + ((((int)threadIdx.x) >> 1) * 4096)) + (((int)blockIdx.z) * 512)) + ((((int)threadIdx.x) & 1) * 16)) + 32)])));
  }
  tl::cp_async_commit();
  #pragma unroll
  for (int i_3 = 0; i_3 < 2; ++i_3) {
    tl::cp_async_gs<16>((&(((fp8_e4_t*)W_sh)[((((i_3 * 2048) + ((((int)threadIdx.x) >> 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 16)) + 8192)])), (&(W[(((((((((int)blockIdx.y) * 4194304) + (((int)blockIdx.x) * 524288)) + (i_3 * 262144)) + ((((int)threadIdx.x) >> 1) * 4096)) + (((int)blockIdx.z) * 512)) + ((((int)threadIdx.x) & 1) * 16)) + 64)])));
  }
  tl::cp_async_commit();
  for (int ko = 0; ko < 13; ++ko) {
    __syncthreads();
    if ((((int)threadIdx.x) >> 3) < m) {
      *(fp8_e4_4_t*)(((fp8_e4_t*)A_sh) + ((((((int)threadIdx.x) >> 3) * 32) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 16)) + ((((int)threadIdx.x) & 3) * 4))) = *(fp8_e4_4_t*)(A + ((((((((int)threadIdx.x) >> 3) * 32768) + (((int)blockIdx.y) * 4096)) + (((int)blockIdx.z) * 512)) + (ko * 32)) + ((((int)threadIdx.x) & 7) * 4)));
    } else {
    ...
    for (int i_6 = 0; i_6 < 2; ++i_6) {
      tl::cp_async_gs<16>((&(((fp8_e4_t*)W_sh)[(((((ko % 3) * 4096) + (i_6 * 2048)) + ((((int)threadIdx.x) >> 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 16))])), (&(W[((((((((((int)blockIdx.y) * 4194304) + (((int)blockIdx.x) * 524288)) + (i_6 * 262144)) + ((((int)threadIdx.x) >> 1) * 4096)) + (((int)blockIdx.z) * 512)) + (ko * 32)) + ((((int)threadIdx.x) & 1) * 16)) + 96)])));
    }
    tl::cp_async_commit();
    #pragma unroll
    for (int i_7 = 0; i_7 < 8; ++i_7) {
      float ASC_local_cast[2];
      *(float2*)(ASC_local_cast + 0) = make_float2(ASC[((((((i_7 & 1) * 8192) + (((((int)threadIdx.x) & 31) >> 2) * 1024)) + (((int)blockIdx.y) * 128)) + (((int)blockIdx.z) * 16)) + ko)], ASC[((((((i_7 & 1) * 8192) + (((((int)threadIdx.x) & 31) >> 2) * 1024)) + (((int)blockIdx.y) * 128)) + (((int)blockIdx.z) * 16)) + ko)]);
      float2 __1;
        float2 __2;
          float2 v_ = *(float2*)(C_p + (i_7 * 2));
          float2 v__1 = *(float2*)(ASC_local_cast + 0);
          *(float2*)(&(__2.x)) = tl::mul2(*(float2*)(&(v_.x)), *(float2*)(&(v__1.x)));
        float2 v__2 = make_float2(((float)WSC[(((((((int)blockIdx.y) * 4096) + (((int)blockIdx.x) * 512)) + ((((int)threadIdx.x) >> 5) * 128)) + (((int)blockIdx.z) * 16)) + ko)]), ((float)WSC[(((((((int)blockIdx.y) * 4096) + (((int)blockIdx.x) * 512)) + ((((int)threadIdx.x) >> 5) * 128)) + (((int)blockIdx.z) * 16)) + ko)]));
  ...
  __syncthreads();
  if ((((int)threadIdx.x) >> 3) < m) {
    *(fp8_e4_4_t*)(((fp8_e4_t*)A_sh) + ((((((int)threadIdx.x) >> 3) * 32) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 16)) + ((((int)threadIdx.x) & 3) * 4))) = *(fp8_e4_4_t*)(A + ((((((((int)threadIdx.x) >> 3) * 32768) + (((int)blockIdx.y) * 4096)) + (((int)blockIdx.z) * 512)) + ((((int)threadIdx.x) & 7) * 4)) + 416));
  } else {
  ...
  __syncthreads();
  {
    ...
    for (int i_9 = 0; i_9 < 2; ++i_9) {
      tl::ptx_ldmatrix_x4((&(((fp8_e4_t*)W_sh)[(((((((((int)threadIdx.x) >> 5) * 1024) + (i_9 * 512)) + (((((int)threadIdx.x) & 31) >> 4) * 256)) + ((((int)threadIdx.x) & 7) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 16)) + 4096)])), (&(B_local_1[(i_9 * 16)])));
    }
  ...
  for (int i_10 = 0; i_10 < 8; ++i_10) {
    ...
    *(float2*)(ASC_local_cast_1 + 0) = make_float2(ASC[((((((i_10 & 1) * 8192) + (((((int)threadIdx.x) & 31) >> 2) * 1024)) + (((int)blockIdx.y) * 128)) + (((int)blockIdx.z) * 16)) + 13)], ASC[((((((i_10 & 1) * 8192) + (((((int)threadIdx.x) & 31) >> 2) * 1024)) + (((int)blockIdx.y) * 128)) + (((int)blockIdx.z) * 16)) + 13)]);
    float2 __3;
      float2 __4;
        float2 v__4 = *(float2*)(C_p + (i_10 * 2));
        float2 v__5 = *(float2*)(ASC_local_cast_1 + 0);
        *(float2*)(&(__4.x)) = tl::mul2(*(float2*)(&(v__4.x)), *(float2*)(&(v__5.x)));
      float2 v__6 = make_float2(((float)WSC[(((((((int)blockIdx.y) * 4096) + (((int)blockIdx.x) * 512)) + ((((int)threadIdx.x) >> 5) * 128)) + (((int)blockIdx.z) * 16)) + 13)]), ((float)WSC[(((((((int)blockIdx.y) * 4096) + (((int)blockIdx.x) * 512)) + ((((int)threadIdx.x) >> 5) * 128)) + (((int)blockIdx.z) * 16)) + 13)]));
  ...
  __syncthreads();
  if ((((int)threadIdx.x) >> 3) < m) {
    *(fp8_e4_4_t*)(((fp8_e4_t*)A_sh) + ((((((int)threadIdx.x) >> 3) * 32) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 16)) + ((((int)threadIdx.x) & 3) * 4))) = *(fp8_e4_4_t*)(A + ((((((((int)threadIdx.x) >> 3) * 32768) + (((int)blockIdx.y) * 4096)) + (((int)blockIdx.z) * 512)) + ((((int)threadIdx.x) & 7) * 4)) + 448));
  } else {
  ...
  __syncthreads();
  {
    ...
    for (int i_12 = 0; i_12 < 2; ++i_12) {
      tl::ptx_ldmatrix_x4((&(((fp8_e4_t*)W_sh)[(((((((((int)threadIdx.x) >> 5) * 1024) + (i_12 * 512)) + (((((int)threadIdx.x) & 31) >> 4) * 256)) + ((((int)threadIdx.x) & 7) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 16)) + 8192)])), (&(B_local_2[(i_12 * 16)])));
    }
  ...
  for (int i_13 = 0; i_13 < 8; ++i_13) {
    ...
    *(float2*)(ASC_local_cast_2 + 0) = make_float2(ASC[((((((i_13 & 1) * 8192) + (((((int)threadIdx.x) & 31) >> 2) * 1024)) + (((int)blockIdx.y) * 128)) + (((int)blockIdx.z) * 16)) + 14)], ASC[((((((i_13 & 1) * 8192) + (((((int)threadIdx.x) & 31) >> 2) * 1024)) + (((int)blockIdx.y) * 128)) + (((int)blockIdx.z) * 16)) + 14)]);
    float2 __5;
      float2 __6;
        float2 v__8 = *(float2*)(C_p + (i_13 * 2));
        float2 v__9 = *(float2*)(ASC_local_cast_2 + 0);
        *(float2*)(&(__6.x)) = tl::mul2(*(float2*)(&(v__8.x)), *(float2*)(&(v__9.x)));
      float2 v__10 = make_float2(((float)WSC[(((((((int)blockIdx.y) * 4096) + (((int)blockIdx.x) * 512)) + ((((int)threadIdx.x) >> 5) * 128)) + (((int)blockIdx.z) * 16)) + 14)]), ((float)WSC[(((((((int)blockIdx.y) * 4096) + (((int)blockIdx.x) * 512)) + ((((int)threadIdx.x) >> 5) * 128)) + (((int)blockIdx.z) * 16)) + 14)]));
  ...
  __syncthreads();
  if ((((int)threadIdx.x) >> 3) < m) {
    *(fp8_e4_4_t*)(((fp8_e4_t*)A_sh) + ((((((int)threadIdx.x) >> 3) * 32) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 16)) + ((((int)threadIdx.x) & 3) * 4))) = *(fp8_e4_4_t*)(A + ((((((((int)threadIdx.x) >> 3) * 32768) + (((int)blockIdx.y) * 4096)) + (((int)blockIdx.z) * 512)) + ((((int)threadIdx.x) & 7) * 4)) + 480));
  } else {
  ...
  __syncthreads();
  {
    ...
    for (int i_15 = 0; i_15 < 2; ++i_15) {
      tl::ptx_ldmatrix_x4((&(((fp8_e4_t*)W_sh)[((((((((int)threadIdx.x) >> 5) * 1024) + (i_15 * 512)) + (((((int)threadIdx.x) & 31) >> 4) * 256)) + ((((int)threadIdx.x) & 7) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 16))])), (&(B_local_3[(i_15 * 16)])));
    }
  ...
  for (int i_16 = 0; i_16 < 8; ++i_16) {
    ...
    *(float2*)(ASC_local_cast_3 + 0) = make_float2(ASC[((((((i_16 & 1) * 8192) + (((((int)threadIdx.x) & 31) >> 2) * 1024)) + (((int)blockIdx.y) * 128)) + (((int)blockIdx.z) * 16)) + 15)], ASC[((((((i_16 & 1) * 8192) + (((((int)threadIdx.x) & 31) >> 2) * 1024)) + (((int)blockIdx.y) * 128)) + (((int)blockIdx.z) * 16)) + 15)]);
    float2 __7;
      float2 __8;
        float2 v__12 = *(float2*)(C_p + (i_16 * 2));
        float2 v__13 = *(float2*)(ASC_local_cast_3 + 0);
        *(float2*)(&(__8.x)) = tl::mul2(*(float2*)(&(v__12.x)), *(float2*)(&(v__13.x)));
      float2 v__14 = make_float2(((float)WSC[(((((((int)blockIdx.y) * 4096) + (((int)blockIdx.x) * 512)) + ((((int)threadIdx.x) >> 5) * 128)) + (((int)blockIdx.z) * 16)) + 15)]), ((float)WSC[(((((((int)blockIdx.y) * 4096) + (((int)blockIdx.x) * 512)) + ((((int)threadIdx.x) >> 5) * 128)) + (((int)blockIdx.z) * 16)) + 15)]));
  ...
  for (int i_17 = 0; i_17 < 8; ++i_17) {
    *(float2*)(P + ((((((((((int)blockIdx.z) * 131072) + (((int)blockIdx.y) * 16384)) + ((i_17 & 1) * 8192)) + (((((int)threadIdx.x) & 31) >> 2) * 1024)) + (((int)blockIdx.x) * 128)) + ((((int)threadIdx.x) >> 5) * 32)) + ((i_17 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(C_l + (i_17 * 2));
  }
}
