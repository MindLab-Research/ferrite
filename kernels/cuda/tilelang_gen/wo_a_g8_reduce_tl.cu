...
extern "C" __global__ void main_kernel(float* __restrict__ OUT, const float* __restrict__ P, int m);
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(float* __restrict__ OUT, const float* __restrict__ P, int m) {
  #pragma unroll
  for (int i = 0; i < 2; ++i) {
    if (((i * 8) + (((int)threadIdx.x) >> 5)) < m) {
      ulonglong4 __1;
        ulonglong4 __2;
          ulonglong4 __3;
            ulonglong4 __4;
              ulonglong4 __5;
                ulonglong4 __6;
                  ulonglong4 __7;
                    ulonglong4 v_ = tl::load_global_256(&(*(ulonglong4*)(P + (((((((int)blockIdx.y) * 16384) + (i * 8192)) + ((((int)threadIdx.x) >> 5) * 1024)) + (((int)blockIdx.x) * 256)) + ((((int)threadIdx.x) & 31) * 8)))));
                    ulonglong4 v__1 = tl::load_global_256(&(*(ulonglong4*)(P + ((((((((int)blockIdx.y) * 16384) + (i * 8192)) + ((((int)threadIdx.x) >> 5) * 1024)) + (((int)blockIdx.x) * 256)) + ((((int)threadIdx.x) & 31) * 8)) + 131072))));
                  ...
                  ulonglong4 v__2 = tl::load_global_256(&(*(ulonglong4*)(P + ((((((((int)blockIdx.y) * 16384) + (i * 8192)) + ((((int)threadIdx.x) >> 5) * 1024)) + (((int)blockIdx.x) * 256)) + ((((int)threadIdx.x) & 31) * 8)) + 262144))));
                ...
                ulonglong4 v__3 = tl::load_global_256(&(*(ulonglong4*)(P + ((((((((int)blockIdx.y) * 16384) + (i * 8192)) + ((((int)threadIdx.x) >> 5) * 1024)) + (((int)blockIdx.x) * 256)) + ((((int)threadIdx.x) & 31) * 8)) + 393216))));
              ...
              ulonglong4 v__4 = tl::load_global_256(&(*(ulonglong4*)(P + ((((((((int)blockIdx.y) * 16384) + (i * 8192)) + ((((int)threadIdx.x) >> 5) * 1024)) + (((int)blockIdx.x) * 256)) + ((((int)threadIdx.x) & 31) * 8)) + 524288))));
            ...
            ulonglong4 v__5 = tl::load_global_256(&(*(ulonglong4*)(P + ((((((((int)blockIdx.y) * 16384) + (i * 8192)) + ((((int)threadIdx.x) >> 5) * 1024)) + (((int)blockIdx.x) * 256)) + ((((int)threadIdx.x) & 31) * 8)) + 655360))));
          ...
          ulonglong4 v__6 = tl::load_global_256(&(*(ulonglong4*)(P + ((((((((int)blockIdx.y) * 16384) + (i * 8192)) + ((((int)threadIdx.x) >> 5) * 1024)) + (((int)blockIdx.x) * 256)) + ((((int)threadIdx.x) & 31) * 8)) + 786432))));
        ...
        ulonglong4 v__7 = tl::load_global_256(&(*(ulonglong4*)(P + ((((((((int)blockIdx.y) * 16384) + (i * 8192)) + ((((int)threadIdx.x) >> 5) * 1024)) + (((int)blockIdx.x) * 256)) + ((((int)threadIdx.x) & 31) * 8)) + 917504))));
      ...
      tl::store_global_256(&(*(ulonglong4*)(OUT + (((((i * 65536) + ((((int)threadIdx.x) >> 5) * 8192)) + (((int)blockIdx.y) * 1024)) + (((int)blockIdx.x) * 256)) + ((((int)threadIdx.x) & 31) * 8)))), __1);
    }
  }
}
