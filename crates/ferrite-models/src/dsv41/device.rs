...
impl Device {
    ...
    pub fn quant_fp8(
        ...
        // `DSV41_ACTQ_FLOOR=1`: the official floors amax (`max(amax, 1e-4)`, kernel.py:76) before
        // deriving the scale; our kernel floored the scale itself (`fmaxf(s, 1e-30)`), which can also
